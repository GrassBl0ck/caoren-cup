...
namespace CaorenCup.WeaponPaints
{
	public partial class CaorenWeaponPaintsPlugin
	{
		...
		{
			if (!WeaponPaintsUtility.IsPlayerValid(player) || (LifeState_t)player.LifeState != LifeState_t.LIFE_ALIVE) return;
		...
		private static CCSPlayerController? GetPlayerFromItemServices(CCSPlayer_ItemServices itemServices)
		{
			...
			return !WeaponPaintsUtility.IsPlayerValid(player) ? null : player;
		}
